...
<!-- covers: spec.workspace.agents_present spec.workspace.reconcile_loop -->
...
- For bug fixes, prefer `mix spec.assist --bugfix`.
...
- Finish with `mix spec.verify --debug`, `mix spec.check`, and `mix spec.diffcheck` when the change set should pass diff-aware enforcement.
