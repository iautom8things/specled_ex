...
- `specs/config.spec.md` — `.spec/config.yml` loader contract (authored)
- `specs/tag_scanning.spec.md` — AST-based `@tag spec:` scanner contract (authored)
- `state.json` — generated by `mix spec.validate` (derived cache; freely regenerable)
- `realization_hashes.json` — committed realization-hash baseline (tool-managed; rewritten by `mix spec.check`)
